...
__all__ = ["test_contact_point_normalizes_inputs", "test_contact_patch_computes_centroid_and_force", "test_friction_cone_check_accepts_force_inside_cone", "test_friction_cone_check_rejects_force_outside_cone", "test_surface_contacts_parallel_jaw_returns_opposed_pair", "test_surface_contacts_suction_returns_single_face_contact", "test_surface_contacts_three_finger_returns_triplet", "test_surface_contacts_rejects_aperture_too_small", "test_force_closure_positive_for_antipodal_contacts", "test_force_closure_negative_for_single_contact", "test_grasp_wrench_space_has_expected_shape", "test_min_resisted_wrench_positive_for_stable_antipodal_grasp", "test_min_resisted_wrench_is_zero_for_empty_contacts", "test_slip_margin_positive_when_load_is_safe", "test_slip_margin_negative_when_tangential_load_is_high", "test_parallel_jaw_planner_returns_ranked_grasps", "test_suction_planner_returns_face_grasps", "test_three_finger_planner_returns_tripod_contacts", "test_antipodal_grasps_returns_axis_aligned_candidates", "test_planner_rejects_oversized_object_for_parallel_jaw", "test_planner_rejects_unreachable_grasps_when_robot_is_provided", "test_evaluate_grasp_is_deterministic", "test_grasp_executor_returns_result_with_contacts", "test_grasp_executor_reports_failure_for_unstable_zero_friction_grasp", "test_grasp_cli_parser_accepts_subcommand", "test_grasp_cli_prints_ranked_results", "test_task_example_path_exists_for_cli_smoke"]
